		...
		<script  src="<?php echo base_url();?>assets/admin/plugins/jquery-mockjax/jquery.mockjax.js"></script>
		...
		<script  src="<?php echo base_url();?>assets/admin/plugins/DataTables/media/js/DT_bootstrap.js"></script>
