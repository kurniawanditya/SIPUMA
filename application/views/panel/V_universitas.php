                  ...
                  <div class="row">
                    <div class="col-md-12 space20">
                      <button class="btn btn-primary" onclick="add_universitas()">
                        <i class="glyphicon glyphicon-plus"></i> Add Universitas
                      </button>
                    </div>
                  </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h3 class="modal-title"><i class="fa fa-plus-square teal"></i> Universitas Form</h3>
      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" placeholder="Insert your universitas name" class="form-control" id="universitas_name" name="universitas_name">
                        </div>
                        <!-- INPUT DESCRIPTION-->
                        <div class="form-group">
                          <label class="control-label">
                          ...
                          <textarea name="universitas_desc" placeholder="Insert your description" class="autosize form-control" id="form-field-24" style="overflow: hidden; word-wrap: break-word; resize: horizontal; height: 69px;"></textarea>
                        </div>
                        <!-- INPUT STATUS-->
                        <div class="form-group">
                          <label class="control-label">
