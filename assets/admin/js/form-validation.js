...
// function to initiate Validation for form role
    var runValidatorrole = function () {
        var form1 = $('#formrole');
        var errorHandler1 = $('.errorHandler', form1);
        var successHandler1 = $('.successHandler', form1);
        $.validator.addMethod("FullDate", function () {
    ...
    // function to initiate Validation for form fakultas
    var runValidatorfakultas = function () {
        var form1 = $('#formfakultas');
        var errorHandler1 = $('.errorHandler', form1);
        var successHandler1 = $('.successHandler', form1);
        $.validator.addMethod("FullDate", function () {
            //if all values are selected
    ...
    // function to initiate Validation for form universitas
    var runValidatoruniversitas = function () {
        var form1 = $('#formuniversitas');
        var errorHandler1 = $('.errorHandler', form1);
        var successHandler1 = $('.successHandler', form1);
        $.validator.addMethod("FullDate", function () {
            //if all values are selected
    ...
    // function to initiate Validation for form hima
    var runValidatorhima = function () {
        var form1 = $('#formhima');
        var errorHandler1 = $('.errorHandler', form1);
        var successHandler1 = $('.successHandler', form1);
        $.validator.addMethod("FullDate", function () {
    ...
    // function to initiate Validation for form posting
    var runValidatorposting = function () {
        var form1 = $('#formposting');
        var errorHandler1 = $('.errorHandler', form1);
        var successHandler1 = $('.successHandler', form1);
        $.validator.addMethod("FullDate", function () {
            //if all values are selected
    ...
    return {
        ...
        init: function () {
            ...
            runValidator2();
            runValidatorrole();
            runValidatorfakultas();
            runValidatoruniversitas();
            runValidatorhima();
            runValidatorposting();
        }
    };
